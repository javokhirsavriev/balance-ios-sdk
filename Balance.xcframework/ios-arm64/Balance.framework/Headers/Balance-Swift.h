...
#ifndef BALANCE_SWIFT_H
#define BALANCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Balance",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface BalanceAppearance : NSObject
...
enum BalanceEntryMode : NSInteger;
enum BalancePresentationStyle : NSInteger;
@class BalancePreviewSettings;
@class BalanceStepSettings;

SWIFT_CLASS("_TtC7Balance13BalanceConfig")
...
typedef SWIFT_ENUM(NSInteger, BalanceLocale, open) {
  BalanceLocaleKyrgyz = 0,
  BalanceLocaleEnglish = 1,
...
typedef SWIFT_ENUM(NSInteger, BalancePresentationStyle, open) {
  BalancePresentationStyleFull = 0,
  BalancePresentationStyleSheet = 1,
};


SWIFT_CLASS("_TtC7Balance22BalancePreviewSettings")
...
SWIFT_CLASS("_TtC7Balance13BalanceResult")
...
SWIFT_CLASS("_TtC7Balance19BalanceStepSettings")
@interface BalanceStepSettings : NSObject
